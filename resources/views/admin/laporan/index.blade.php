...
<div class="flex flex-wrap items-center justify-between gap-4 mb-6">
    ...
    <div class="flex items-center gap-2">
        <a href="{{ env('EXCEL_ONLINE_URL') ?? '#' }}" @if(!env('EXCEL_ONLINE_URL')) onclick="alert('PENTING: Anda belum memasukkan link Google Sheets Anda. Silakan buka file .env dan tambahkan baris EXCEL_ONLINE_URL=https://link-spreadsheet-anda.com'); return false;" @else target="_blank" @endif class="inline-flex items-center gap-2 px-4 py-2.5 rounded-2xl text-xs font-bold bg-emerald-600 hover:bg-emerald-700 text-white shadow-md shadow-emerald-600/20 hover:-translate-y-0.5 transition-all cursor-pointer" title="Buka Google Sheets">
